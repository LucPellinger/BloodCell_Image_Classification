...
st.set_page_config(page_title="🧪 Model Optimization History – Blood Cell Image Classification", layout="wide")

render_logo(title="🧪 Model Optimization History (Optuna)")
